<template>
  <el-col :span="20">
    ...
    >
      ...
      <el-table-column align="right">//右对齐
        ...
        <template slot-scope="scope">
          <el-button size="mini" @click="handleEdit(scope.$index, scope.row)">选座</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="block">
...
export default {
  ...
  methods: {
    ...
    handleEdit (index, row) {
      ...
      this.$router.push({ path: '/Ticket/Editing' })
    },
    /* 删除 */
